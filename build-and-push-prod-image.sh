...
docker buildx build --platform linux/amd64 --build-arg REACT_APP_BASE_URL=$BASE_URL -t masnottuh/group-complete:$NEW_VERSION . --no-cache

docker push masnottuh/group-complete:$NEW_VERSION